# -*- encoding: utf-8 -*-
# stub: raindrops 0.20.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.add_development_dependency(%q<aggregate>.freeze, ["~> 0.2".freeze])
  s.add_development_dependency(%q<test-unit>.freeze, ["~> 3.0".freeze])
  s.add_development_dependency(%q<posix_mq>.freeze, ["~> 2.0".freeze])
  s.add_development_dependency(%q<rack>.freeze, [">= 1.2".freeze, "< 3.0".freeze])
end
